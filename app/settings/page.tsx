...
import { units, mockUsers } from "@/lib/mock-data"
import { Plus, Pencil, Trash2, Building2, GitBranch, Cog, Users } from "lucide-react"
      ...
      <div className="p-6 space-y-6 text-right" dir="rtl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="bg-secondary border border-border">
            <TabsTrigger value="units" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2">
              <Building2 className="h-4 w-4" />
              واحدها و خطوط
            </TabsTrigger>
            <TabsTrigger value="machines" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2">
              <Cog className="h-4 w-4" />
              ماشین‌آلات
            </TabsTrigger>
            <TabsTrigger value="targets" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground gap-2">
          ...
          <TabsContent value="units" className="mt-6">
            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                ...
                <Button size="sm" onClick={() => openAdd("unit")} className="bg-primary text-primary-foreground hover:bg-primary/90">
                  ...
                  {units.map((unit) => (
                    <div key={unit.id} className="rounded-lg border border-border p-4">
                      ...
                      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                        {unit.lines.map((line) => (
                          <div key={line.id} className="flex items-center justify-between rounded-md bg-secondary px-3 py-2">
                            <div>
          ...
          <TabsContent value="machines" className="mt-6">
            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                ...
                <Button size="sm" onClick={() => openAdd("machine")} className="bg-primary text-primary-foreground hover:bg-primary/90">
                  <Plus className="ml-1 h-4 w-4" />
                  افزودن ماشین
                </Button>
              </CardHeader>
          ...
          <TabsContent value="users" className="mt-6">
            <Card className="bg-card border-border">
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                ...
                <Button size="sm" onClick={() => openAdd("user")} className="bg-primary text-primary-foreground hover:bg-primary/90">
                  <Plus className="ml-1 h-4 w-4" />
                  افزودن کاربر
                </Button>
              </CardHeader>
        ...
        <Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
          <DialogContent className="max-w-md bg-card text-card-foreground border-border">
              ...
              {addType === "user" && (
                <>
                  <div className="space-y-2">
                    ...
                    <Input placeholder="مثال: علی رضایی" className="bg-secondary text-secondary-foreground placeholder:text-muted-foreground" />
                  </div>
                  <div className="space-y-2">
                    <Label className="text-card-foreground">نام کاربری</Label>
                    <Input placeholder="مثال: a.rezaei" className="bg-secondary text-secondary-foreground placeholder:text-muted-foreground" dir="ltr" />
                  </div>
                  <div className="space-y-2">
            ...
            <DialogFooter className="gap-2">
              ...
              <Button onClick={() => setAddDialogOpen(false)} className="bg-primary text-primary-foreground hover:bg-primary/90">
                ذخیره
              </Button>
            </DialogFooter>
          </DialogContent>
